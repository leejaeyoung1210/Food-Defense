...
//        if (hit == null) // 땅바닥 찍으면 리턴
//        {
//            lr.positionCount = 0; //라인클리어
//            return;
//        }
//        else if (hit.gameObject == this.gameObject)// 어딘가 찍엇다 그럼 자신인지 검사 필요 
//        {
//            isSelected = true;
...
//            lr.positionCount = 0; //라인클리어          
//        }
//        Console.WriteLine(hit.gameObject.name);
//    }
...
//        {
//            Vector3 dir = (dragPos - startPos).normalized;
//            Vector3 capped = startPos + dir * 10f;
...
//            if (hit != null) // 설치가 가능한 스폿에 닿았는지 확인    
//            {// 타워가 있음
//                TowerSpot targetspot = hit.GetComponent<TowerSpot>();
//                if (targetspot == null)
//                {
//                    Debug.Log("타워 스폿이 아님");
//                    endPos = startPos;
